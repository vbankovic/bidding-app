...
public class TenderControllerTest {
  ...
  public void createTender() throws Exception {
    ...
    mockMvc.perform(post("/v1/tenders")
  ...
  public void addOffer() throws Exception {
    ...
    mockMvc.perform(post("/v1/tenders/{id}/offers", tender.getId())
            .contentType(APPLICATION_JSON)
            .content(jsonRequest))
            .andExpect(status().isOk())
  ...
  public void acceptOffer() throws Exception {
    mockMvc.perform(put("/v1/tenders/{tenderId}/offers/{offerId}/accept", tender.getId(), offer.getId()))
            .andExpect(status().isOk())
  ...
  public void findAllByIssuer() throws Exception {
    mockMvc.perform(get("/v1/tenders")
            .param("issuer_id", String.valueOf(tender.getIssuerId())))
            .andExpect(status().isOk())
  ...
  public void getAllOffers() throws Exception {
    mockMvc.perform(get("/v1/tenders/{id}/offers", tender.getId())
